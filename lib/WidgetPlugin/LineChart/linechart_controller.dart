...
class linechart_controller extends GetxController {
  ...
  static Getdata({required ModelLinechart modellinechart}) {
    ...
    for (var i in linechart_controller
        .model_linechart.value!.linechartdata!.lefttileNames!) {
  ...
  static List<int> getMonthNumbersanddays(ModelLinechart modellinechart) {
